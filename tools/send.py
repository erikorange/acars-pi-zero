...
def loadTestData():
    ...
    x.append('{"timestamp":1646790694.823307,"station_id":"rpi-zero-1","channel":0,"freq":131.550,"level":-14,"error":0,"mode":"2","label":"Q0","block_id":"6","ack":false,"tail":"N641AE","flight":"UA1001","msgno":"M32A","text":"Message1Message1Message1Message1Message1"}')
